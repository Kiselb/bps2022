...
export type WizardPagesTypes_BANKACCOUNT = { type: "BANKACCOUNT", primary: boolean, subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, fee: boolean, registration: boolean };
export type WizardPagesTypes_CASHACCOUNT = { type: "CASHACCOUNT", primary: boolean, subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, fee: boolean, registration: boolean };
export type WizardPagesTypes_PERSONALACCOUNT = { type: "PERSONALACCOUNT", primary: boolean, subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, fee: boolean, registration: boolean };
export type WizardPagesTypes_LENDINGACCOUNT = { type: "LENDINGACCOUNT", primary: boolean, direction: -1 | 1, registration: boolean };
export type WizardPagesTypes_EXTERNALACCOUNT = { type: "EXTERNALACCOUNT", primary: boolean, subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, fee: boolean, registration: boolean };
export type WizardPagesTypes_COFFERACCOUNT = { type: "COFFERACCOUNT", primary: boolean, subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, registration: boolean };
export type WizardPagesTypes_OVERDRAFT = { type: "OVERDRAFT", primary: boolean, direction: -1 | 1, registration: boolean };
export type WizardPagesTypes_SERVICEFEE = { type: "SERVICEFEE" };
export type WizardPagesTypes_ARTICLE = { type: "ARTICLE", subtype: "INCOME" | "EXPENSES", registration: boolean };
export type WizardPagesTypes_CONFIRMATION = { type: "CONFIRMATION" };

export type WizardPagesTypes_REGBANKACCOUNT = { type: "REGBANKACCOUNT", subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1, registration: boolean };
export type WizardPagesTypes_REGORGANIZATION = { type: "REGORGANIZATION", subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1 };
export type WizardPagesTypes_REGCASHACCOUNT = { type: "REGCASHACCOUNT", subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1 };
export type WizardPagesTypes_REGPERSONALACCOUNT = { type: "REGPERSONALACCOUNT", subtype: "INTERNAL" | "EXTERNAL" };
export type WizardPagesTypes_REGLENDINGACCOUNT = { type: "REGLENDINGACCOUNT" };
export type WizardPagesTypes_REGEXTERNALACCOUNT = { type: "REGEXTERNALACCOUNT", subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1 };
export type WizardPagesTypes_REGCOFFERACCOUNT = { type: "REGCOFFERACCOUNT", subtype: "INTERNAL" | "EXTERNAL", direction: -1 | 1 };
export type WizardPagesTypes_REGOVERDRAFT = { type: "REGOVERDRAFT" };
export type WizardPagesTypes_REGARTICLE = { type: "REGARTICLE", subtype: "INCOME" | "EXPENSES" };
...
export const automaton: Automaton = [
    ...
    ["01-010", null, ["BAE", "BAE"], [
        ...
        { type: "BANKACCOUNT", primary: true, subtype: "EXTERNAL", direction: -1, fee: false, registration: true },
        { type: "REGBANKACCOUNT", subtype: "EXTERNAL", direction: -1, registration: true },
        { type: "REGORGANIZATION", subtype: "EXTERNAL", direction: -1 },

        { type: "BANKACCOUNT", primary: true, subtype: "EXTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGBANKACCOUNT", subtype: "EXTERNAL", direction: 1, registration: true },
        { type: "REGORGANIZATION", subtype: "EXTERNAL", direction: 1 },

        { type: "EXTERNALACCOUNT", primary: false, subtype: "INTERNAL", direction: 1, fee: true, registration: true },
        { type: "REGEXTERNALACCOUNT", subtype: "INTERNAL", direction: 1 },

        { type: "ARTICLE", subtype: "INCOME", registration: true },
        { type: "REGARTICLE", subtype: "INCOME" },
    ...
    ["01-020", null, ["BAE", "BAE"], [
        ...
        { type: "PERSONALACCOUNT", primary: false, subtype: "EXTERNAL", direction: 1, fee: true, registration: true },
        { type: "REGPERSONALACCOUNT", subtype: "EXTERNAL" },
    ...
    ["01-030", null, ["BAE", "BAE"], [
        ...
        { type: "EXTERNALACCOUNT", primary: false, subtype: "INTERNAL", direction: -1, fee: true, registration: false },
        { type: "EXTERNALACCOUNT", primary: false, subtype: "INTERNAL", direction: 1, fee: true, registration: true },
        { type: "REGEXTERNALACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["01-050", null, ["BAE", "BAE"], [
        ...
        { type: "EXTERNALACCOUNT", primary: false, subtype: "INTERNAL", direction: -1, fee: true, registration: false },
        { type: "ARTICLE", subtype: "EXPENSES", registration: true },
        { type: "REGARTICLE", subtype: "EXPENSES" },
    ...
    ["01-060", null, ["BAE", "BAE"], [
        ...
        { type: "PERSONALACCOUNT", primary: false, subtype: "EXTERNAL", direction: -1, fee: true, registration: false },
    ...
    ["02-010", null, ["BAE", "BAI"], [
        ...
        { type: "BANKACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGBANKACCOUNT", subtype: "INTERNAL", direction: 1, registration: true },
        { type: "REGORGANIZATION", subtype: "INTERNAL", direction: 1 },
    ...
    ["04-020", null, ["BAI", "BAI"], [
        ...
        { type: "OVERDRAFT", primary: true, direction: 1, registration: false },
        { type: "CONFIRMATION" },
    ], "Погашение овердрафта"],
    ["04-030", null, ["BAI", "BAI"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "OVERDRAFT", primary: true, direction: -1, registration: true },
        { type: "REGOVERDRAFT" },
    ...
    ["05-010", null, ["BAI", "CAA"], [
        ...
        { type: "CASHACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGCASHACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["09-010", null, ["BAI", "COA"], [
        ...
        { type: "COFFERACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, registration: true },
        { type: "REGCOFFERACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["09-011", null, ["BAI", "COA"], [
        ...
        { type: "COFFERACCOUNT", primary: true, subtype: "EXTERNAL", direction: 1, registration: true },
        { type: "REGCOFFERACCOUNT", subtype: "EXTERNAL", direction: 1 },
    ...
    ["10-010", null, ["CAA", "BAI"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "CASHACCOUNT", primary: true, subtype: "INTERNAL", direction: -1, fee: false, registration: false },
    ...
    ["13-010", null, ["CAA", "XAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "EXTERNALACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: true, registration: true },
        { type: "REGEXTERNALACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["17-010", null, ["PAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: true },
        { type: "PERSONALACCOUNT", primary: true, subtype: "EXTERNAL", direction: -1, fee: true, registration: false },
        { type: "PERSONALACCOUNT", primary: true, subtype: "EXTERNAL", direction: 1, fee: true, registration: true },
        { type: "REGPERSONALACCOUNT", subtype: "EXTERNAL" },
    ...
    ["17-020", null, ["PAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "PERSONALACCOUNT", primary: true, subtype: "EXTERNAL", direction: -1, fee: false, registration: false },
        { type: "ARTICLE", subtype: "INCOME", registration: true },
        { type: "REGARTICLE", subtype: "INCOME" },
    ...
    ["17-030", null, ["PAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "PERSONALACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGPERSONALACCOUNT", subtype: "EXTERNAL" },
    ...
    ["17-040", null, ["PAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "LENDINGACCOUNT", primary: true, direction: -1, registration: true },
    ...
    ["17-050", null, ["PAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "PERSONALACCOUNT", primary: true, subtype: "INTERNAL", direction: -1, fee: false, registration: false },
        { type: "LENDINGACCOUNT", primary: true, direction: 1, registration: false },
    ...
    ["18-010", null, ["PAC", "XAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "EXTERNALACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGEXTERNALACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["21-010", null, ["XAC", "CAA"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "EXTERNALACCOUNT", primary: true, subtype: "INTERNAL", direction: -1, fee: true, registration: false },
        { type: "CASHACCOUNT", primary: true, subtype: "INTERNAL", direction: 1, fee: false, registration: true },
        { type: "REGCASHACCOUNT", subtype: "INTERNAL", direction: 1 },
    ...
    ["22-010", null, ["XAC", "PAC"], [
        { type: "SUMEXCHANGE", exchange: false },
        { type: "EXTERNALACCOUNT", primary: true, subtype: "INTERNAL", direction: -1, fee: false, registration: false },
        { type: "ARTICLE", subtype: "EXPENSES", registration: true },
        { type: "REGARTICLE", subtype: "EXPENSES" },
